...
public class SecurityConfig {
    ...
    public CorsConfigurationSource configurationSource(){
        ...
        corsConfigurationSource.addAllowedMethod("*"); // GET, POST, PUT, DELETE 등의 모든 메서드 허용
        corsConfigurationSource.addAllowedOriginPattern("*"); // 모든 IP 주소 허용
