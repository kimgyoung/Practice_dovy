package com.example.login_test.weather;
...
public class WeatherController {
    ...
    public ResponseEntity<?> getWeather() throws JsonProcessingException {
        ...
        String city = "Busan";
        String apikey = "154124370686121d31affedf84ed25c9";
        String phoneNumber = "01083937924";
        ...
        String weatherResult = "온도 : " + weatherResponse.getMain().getTemp()
                +"경도 : " + weatherResponse.getCoord().getLon()
                +"위도 : " + weatherResponse.getCoord().getLat();
