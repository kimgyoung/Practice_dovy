...
import com.example.login_test.weather.WeatherController;
...
public class UserController {
     ...
     */
    @PostMapping("/join")
    public ResponseEntity<?> join(@RequestBody @Valid UserRequest.JoinDTO requestDTO, Error error) throws JsonProcessingException {
