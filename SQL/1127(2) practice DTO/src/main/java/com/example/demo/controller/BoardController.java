...
public class BoardController {
    ...
    public String save(@ModelAttribute BoardDto boardDto, @RequestParam MultipartFile[] files, FileDto fileDto) throws IOException {
        boardDto.setCreateTime(LocalDateTime.now());
        boardService.save(boardDto, files, fileDto);
