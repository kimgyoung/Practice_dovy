...
public class ProductService {
    ...
    public ProductResponse.FindByIdDto findById(Long id) {
        ...
        // 반환 값이 이게 아니기 때문에 오류 남 // 옵셔널로 반환 해야 하는데 // 리스트로 해버리니까..
    ...
    public List<Option> findById(Long id) {
        ...
        // 따라서 id를 product.getId()로 Option 상품 검색
        List<Option> productDtos = optionRepositry.findByProductId(product.getId());

        // 반환 값이 이게 아니기 때ㅔ문에 오류 남 // 옵셔널로 반환해야하는데 // 리스트로 해버리니까..
